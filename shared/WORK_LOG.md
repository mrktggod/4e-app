...
**Задача:** Поставить Юре задачу по responsive UI redesign профиля
**Результат:** Добавлены и расширены `BUG-2026-07-05-002`, `BACK-043`, QA-регрессия и task-файл `docs/tasks/BUG-2026-07-05-002_profile_mobile_layout.md`. Требование: переработать профиль как цельную форму на mobile/desktop web без смены цветовой схемы и шрифта — сетка, поля, статусы phone/email/telegram, секции "Дата рождения" и "О себе", textarea и счётчик символов.
**Коммит:** N/A
**Статус:** ✅ задача оформлена
**Следующий шаг:** Юрий делает фикс в ветке `fix/profile-responsive-ui`, затем Алексей проверяет desktop web, mobile web и Telegram WebView перед merge
...
**Результат:** Добавлены `BUG-2026-07-05-001`, `BACK-042`, QA-регрессия и task-файл `docs/tasks/BUG-2026-07-05-001_bottom_nav_width.md`. Требование: нижняя панель должна быть по ширине app-контейнера на всех экранах, где она видна; проверить оба компонента `bottom-nav-v2` и `global-nav`.
**Коммит:** N/A
**Статус:** ✅ задача оформлена
