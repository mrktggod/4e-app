...
| `AGENTS.md` | 179 | Правила для Codex и агентов | Читать перед задачей |
...
| `DEVELOPMENT_LOG.md` | 418 | Канонический технический лог | Обновлять после значимых правок |
| `shared/WORK_LOG.md` | 85 | Общий журнал задач команды | Обновлять после выполненной задачи |
