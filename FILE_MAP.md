...
| `AGENTS.md` | 175 | Правила для Codex и агентов | Читать перед задачей |
...
| `DEVELOPMENT_LOG.md` | 387 | Канонический технический лог | Обновлять после значимых правок |
| `shared/WORK_LOG.md` | 65 | Общий журнал задач команды | Обновлять после выполненной задачи |
