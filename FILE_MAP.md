...
| --- | ---: | --- | --- |
| `index.html` | 5812 | Telegram Mini App: CSS, HTML-экраны, JS-логика | Через `FILE_MAP_UI.md`, только нужный диапазон |
...
| `AGENTS.md` | 177 | Правила для Codex и агентов | Читать перед задачей |
| `CLAUDE.md` | 114 | Контекст проекта для Claude/Cowork | Читать при координации |
| `COWORK_INSTRUCTIONS.md` | 132 | Инструкции наблюдателя/координатора | Читать при планировании |
| `DEVELOPMENT_LOG.md` | 403 | Канонический технический лог | Обновлять после значимых правок |
| `shared/WORK_LOG.md` | 75 | Общий журнал задач команды | Обновлять после выполненной задачи |
