...
| `docs/tasks/SMART-014-voice-multi-task-day-plan.md` | Полное ТЗ голосового разбора нескольких задач и контролируемого плана дня |
| `pm/inbox/BRIEF-2026-07-29-100-smart-014-voice-multi-task-mvp.md` | Исполняемая постановка SMART-014 со статусом `NEW`, ограничениями MVP и проверками |
