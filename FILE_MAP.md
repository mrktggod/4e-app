...
| --- | ---: | --- | --- |
| `index.html` | 6222 | Telegram Mini App: CSS, HTML-экраны, JS-логика | Через `FILE_MAP_UI.md`, только нужный диапазон |
...
| `DEVELOPMENT_LOG.md` | 519 | Канонический технический лог | Обновлять после значимых правок |
