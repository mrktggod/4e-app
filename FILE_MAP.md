...
| `AGENTS.md` | 234 | Правила для Codex и агентов | Читать перед задачей |
...
| `DEVELOPMENT_LOG.md` | 1204 | Канонический технический лог | Обновлять после значимых правок |
| `shared/ROADMAP.md` | 154 | Единственный roadmap продукта: стратегия, горизонты, решения, Now / Next / Later | Читать при планировании |
| `shared/WORK_LOG.md` | 682 | Общий журнал задач команды | Обновлять после выполненной задачи |
| `shared/COMMIT_CONVENTION.md` | 64 | Правила понятных заголовков коммитов | Читать перед коммитом |
| `docs/git-team-rules.md` | 129 | Git-процесс команды: ветки, commit, push/merge, согласование рисков | Читать при push/merge/ветках |
| `docs/team-sync-protocol.md` | 164 | Team Sync: ключевые фразы `Что там у Лехи?` / `Что там у Юры?`, commit/push и отчёты | Читать при синхронизации Алексея и Юрия |
...
| `pm/team-sync.md` | Короткий диспетчерский экран: что Алексей передал Юре, что Юра вернул, что заблокировано |
