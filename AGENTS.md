...
- Диск C: для файлов проекта не используется. Папка `Documents\4` на диске C существует и ожидает отдельного решения об архивировании; она не является каноном и не используется automation.
