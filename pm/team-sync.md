...
### Live QA 2026-07-20 — календарь меняет действие центральной кнопки

**Статус:** Передано
**Контекст:** Алексей прошёл live smoke `NEW-006` / `NEW-008` в Telegram Mini App на iPhone. Safe area и keyboard-overlap не воспроизвелись, но переход в календарь выявил отдельный P1.
**Ветка:** `docs/qa-calendar-nav-regression-20260720`
**Что нужно от Юры:** принять `BUG-2026-07-20-001`, исправить единую карту нижней навигации и вернуть короткий тап центральной кнопки к текстовому AI-чату; отдельно учесть P2 `BUG-2026-07-20-002` с сырой ISO-датой.
**Handoff:** `pm/agent-inbox/codex-to-yuri-2026-07-20-calendar-nav-regression.md`
**Следующий шаг:** Юрий делает фикс в отдельной ветке и возвращает staging-ссылку; Алексей повторяет сценарий на iPhone. Merge в `main` без повторного smoke не делать.
