...
| BUG-2026-07-25-015 | AI chat: команда удалить задачи была выполнена как перенос всех активных задач в выполненные | Critical | P0 | Triaged / queued for night | Codex + Claude review if broad | SMART-004 / BACK-019 | Пользователь попросил удалить все задачи, AI не удалил их, но массово отметил активные задачи выполненными. Ожидание: destructive intent `удали` нельзя подменять на `заверши`; для массового удаления нужен явный confirm, а при невозможности удаления не выполнять другое destructive/bulk действие. |
