...
| BUG-2026-07-05-001 | Нижняя панель растягивается на ширину браузера, а не экрана приложения | Medium | P2 | Triaged | Юрий | BACK-046 | Скрин Алексея 2026-07-05; проверить все экраны с нижней панелью |
>>>>>>> Stashed changes
...
=======
**Решение:** завести отдельный UI-фикс `BACK-046`. Юре проверить оба компонента навигации в `index.html`: `bottom-nav-v2` внутри `#home` и `global-nav` для остальных экранов. Исправление должно ограничивать ширину панели app-контейнером, а не viewport браузера.
>>>>>>> Stashed changes
