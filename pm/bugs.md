...
| BUG-2026-07-25-014 | AI chat: нет понятной кнопки голосового ввода внутри composer | Medium | P2 | Triaged / queued for night | Codex | NEW-009 / NEW-020 | Пользователь не понимает, как продолжить голосовое общение в AI-чате: маленькая иконка микрофона наверху выглядит как индикатор, а не usable input. Ожидание: в composer есть понятный voice entrypoint или явная affordance, которая ведёт в voice flow и не конфликтует с premium gate. |
