...
| BUG-2026-07-21-006 | Уведомления плохо видны и иногда не срабатывают | High | P1 | Triaged | Codex / Yuri QA | BACK-064 | Со слов Алексея: уведомления есть, но их особо не видно, иногда они не срабатывают; нужно полностью проверить и добиться звука/вибрации/видимости. `BACK-055` закрывал action-feed карточки, но не real delivery/salience. Создан task `docs/tasks/BACK-064-notification-salience-delivery-audit.md`; связанный delivery smoke: `docs/tasks/BACK-017-notifications-delivery-smoke.md`. |
