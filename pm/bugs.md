...
| BUG-2026-07-25-010 | Voice consent: чекбокс согласия на биометрию слишком маленький и слабо заметный | Medium | P1 | Triaged / queued for night | Codex | BACK-003 / BACK-050 | На экране `Согласие на обработку голоса` пользователь с небольшим ухудшением зрения не понял, куда ставить галочку. Ожидание: checkbox/touch target минимум 44px, заметный контраст и понятное состояние checked/unchecked без изменения юридического текста. |
