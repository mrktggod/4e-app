...
| --- | --- | --- | --- | --- | --- | --- | --- |
| BUG-2026-06-29-001 | Вход через Telegram показывает тупиковую подсказку, бот не предлагает действие | High | P1 | Triaged | Юрий / bot + Codex / app | BACK-024 | См. `docs/tasks/BUG-2026-06-29-001_telegram_login_dead_end.md` |
| BUG-2026-06-29-002 | Голосовой режим открывается с ошибкой микрофона и не начинает запись | High | P1 | Triaged | Codex + Юрий / worker | BACK-021 | См. `docs/tasks/BACK-021-voice-mediarecorder.md` |
