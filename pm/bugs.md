...
| BUG-2026-07-25-013 | Home dashboard: правый край интерфейса обрезан на телефоне | High | P1 | Triaged / queued for night | Codex | NEW-006 / HOME-001 | На главном экране у пользователя обрезан правый край карточек/статистики/нижней навигации. Ожидание: app shell и dashboard не создают horizontal overflow, все правые края и nav укладываются в viewport/safe-area. |
