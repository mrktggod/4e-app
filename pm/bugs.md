...
| --- | --- | --- | --- | --- |
| BUG-2026-06-25-002 | Сброс пароля принимает некорректный email и переводит пользователя на пустой экран | Пустой email, `fff`, корректный формат с несуществующим/существующим пользователем; отсутствие пустого экрана и нижней навигации на auth/reset-flow | TBD | Awaiting QA |
