...
| BACK-030 | Участники задачи + отправка задачи пользователю 4 | Product/Tech | P1 | Codex | In Progress | Г2 | Добавлять других пользователей 4 в задачу; связывать аккаунты; задача приходит выбранному пользователю в его 4; подсветка что это пользователь 4 |
