...
| BACK-051 | Уведомление после слияния аккаунтов | Product/UX | P3 | Codex | Todo | Г2 | mergeAccounts сейчас выполняется молча: показать разовый тост/баннер после входа: «Мы объединили ваш аккаунт с ранее использованным, все задачи сохранены». Не блокирует BACK-026. |
