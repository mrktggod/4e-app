...
| BACK-044 | ????????? ????????? ???????? ?????? | Product/UI | P2 | Codex | Done | ?1 | ????? `fix/task-detail-card-cleanup`: ???????? ??????? ??? ?????????, ??????? "????????" ??????, ??????? ????? ???????? ? `???? ? ??????? ?????? ? ?????? ? ????????? ? ???????????`; ?????? ?????? ???? "???????????", ? "???????" ????? ????? ? ???????? ????? person picker, mobile rows ???????????? ??????????? ??? ????????? `saveTaskEdits()` |
