...
| BACK-050 | Accessibility baseline критических сценариев | Product/UI/QA | P1 | Юрий + Codex | In Progress | Г1 | Шаг 1 auth/forms подготовлен в `index.html`: login/register/forgot/reset получили labels, `aria-describedby`, `aria-invalid`, полевые ошибки, keyboard submit и видимый focus без новой inline-разметки; дальше status/toast и dialog/focus/touch-targets |
