...
| BACK-048 | Профиль: личные данные под раздел «Личные данные аккаунта» | Product/UI | P2 | Codex | Done | Г1 | Email/телефон/telegram/дата рождения и пр. ПД скрыть из основного экрана профиля под отдельную кнопку/раздел «Личные данные аккаунта». Пожелание Юрия по итогам QA BACK-043 (06.07) |
| BACK-049 | Профиль: настройки фото по клику на аватар, убрать дублирование | Product/UI | P2 | Codex | Done | Г1 | Фото профиля дублируется; настройки фото должны открываться по клику на иконку/аватар (стандартный паттерн приложений). Пожелание Юрия по итогам QA BACK-043 (06.07) |
| BACK-050 | Человекочитаемые значения «Направления» в карточке | Bug/UI | P3 | Codex | Done | Г1 | В поле «Направление» светится сырое значение `outgoing` вместо «Исходящее / Я должен»; замапить значения на русские лейблы везде, где направление отображается. Замечание Юрия на live-smoke BACK-044 (06.07) |
