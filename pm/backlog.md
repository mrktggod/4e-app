...
| INFRA-002 | Чек РФ-доступности без VPN в release-checklist | QA/Process | P1 | Codex (docs) + Алексей | Todo | Г0 | Обязательный пункт: все прод-URL проверяются из РФ-сети без VPN перед любым переключением хостинга/домена. Урок миграции 2026-07-05: неделя тестов шла через VPN на всех устройствах |
