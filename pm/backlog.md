...
| BACK-050 | Accessibility baseline критических сценариев | Product/UI/QA | P1 | Юрий + Codex | Todo | Г1 | Auth-формы имеют явные labels, `aria-describedby`/ошибки и keyboard submit; toast/status читаются как status/alert; quick-add/contact/biometric consent ведут себя как dialog с фокусом; nav/actions имеют видимый focus и достаточные touch-targets; `pm/qa-checklist.md` покрывает ручной accessibility smoke |
