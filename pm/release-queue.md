...
| BRIEF-2026-08-02-122-notifications-functional-audit | Telegram Mini App / web notifications | PR_READY | PR #66, audit `bcc3561`, target `feat/admin-tariff-api`; `smoke:back055` and encoding guard green | NEED-YURI: separate clean worker+bot delivery runner and browser-permission product decision; no live notification from this session |
